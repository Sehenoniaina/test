...
dev:
	@XDEBUG_MODE=debug HTTP_PORT=82 XDEBUG_SESSION=1 $(DOCKER_COMP) up --wait
...
migration-diff:
	@$(DOCKER_COMP) exec php php bin/console doctrine:migrations:diff

migration-migrate:
	@$(DOCKER_COMP) exec php php bin/console doctrine:migrations:migrate --no-interaction

migration_force:
	@$(DOCKER_COMP) exec php php bin/console doctrine:schema:update --force
